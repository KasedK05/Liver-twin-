...
class DefenseStress(Subsystem):
    def initialize_state(self, params):
        return {
            "ros": params.get("ros_0", 0.10),
            "antioxidant": params.get("aod_0", 0.60),
            "dna_repair": params.get("repair_0", 0.20),
            "inflammasome": params.get("inflam_0", 0.05),
            "interferon": params.get("ifn_0", 0.05),
            "viral_load": 0.0,
        }
