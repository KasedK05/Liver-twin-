...
class MembraneTransport(Subsystem):
    def initialize_state(self, params):
        return {
            "integrity": params.get("mem_0", 0.90),
            "na_k_gradient": params.get("nak_0", 0.85),
            "calcium": params.get("ca_0", 0.10),
            "nutrient_uptake": params.get("nut_0", 0.70),
            "vesicle_traffic": params.get("ves_0", 0.60),
        }
    ...
    def update(self, dt, c, d):
        ...
        ves_disrupt = 0.04 * c.get("aggregates", 0)
